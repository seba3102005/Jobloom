...
SECRET_KEY = 'django-insecure-6p*izx#*u6x2h6i$17&t725brc*7g5frpe1skggfpn6@e_a-h6'
...
STATICFILES_DIRS  = [os.path.join(BASE_DIR,'mysite/static')]   ###joining the front_end with the ba
